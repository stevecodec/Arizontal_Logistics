      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-block px-4 py-1 bg-theme-primary/10 border-l-4 border-theme-primary mb-4">
            <span className="text-sm font-semibold text-theme-primary">PARTNERSHIP</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto">
          {whyPartner.map((reason, index) => (
            <div
              key={index}
              className="flex items-center py-4 border-b border-slate-200 last:border-b-0"
            >
              <div className="w-8 h-8 bg-theme-primary text-white flex items-center justify-center font-bold mr-4 flex-shrink-0">
                {index + 1}
              </div>
