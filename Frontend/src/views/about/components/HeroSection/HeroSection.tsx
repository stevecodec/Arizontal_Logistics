...
export const HeroSection = () => {
  return (
    <section className="relative h-[50vh] sm:h-[55vh] flex items-center justify-start pt-20 sm:pt-24 md:pt-20">
      {/* Dark overlay for readability */}
      <div className="absolute inset-0 bg-slate-900/50"></div>

      {/* Hero Content */}
      <div className="relative text-white max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 z-20">
